...
class OrderHistoryPage extends Component {
  ...
  componentWillUpdate(nextProps, nextState){
    ...
    if (type == WS.GET_USER_ORDERS_RESPONSE){
...
const mapActionToProps = (dispatch) => {
  return {
    ...
    // onUpdateOpenedOrder: (order) => {dispatch(orderActions.updateOpenedOrder(order));},
     ...
     onGetUserOrdersCompleted: () => {dispatch({type:WS.GET_USER_ORDERS_RESPONSE_COMPLETED});},
    // onSubmitNormalOrderSuccess: () => {dispatch(orderActions.submitNormalOrderSuccess());},
  }
}
export default connect(mapStateToProps, mapActionToProps)(OrderHistoryPage);
